            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.UpdateListingRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        "models.CreateListingRequest": {
            ...
            "properties": {
                ...
                "description": {
                    "type": "string",
                    "maxLength": 2000,
                    "example": "Modern penthouse with ocean view."
                },
                "location": {
                ...
                "title": {
                    ...
                    "maxLength": 255,
                    "minLength": 3,
                    "example": "Luxury 3-Bedroom Penthouse in Ikoyi"
                },
                "type": {
                    "enum": [
                        "rent",
        ...
        "models.Listing": {
            ...
            "properties": {
                ...
                "description": {
                    "type": "string",
                    "example": "Modern penthouse with ocean view and automated lighting."
                },
                "distance_km": {
                    "type": "number",
                    "example": 2.45
        ...
        "models.Location": {
            ...
            "properties": {
                "address": {
                    "type": "string",
                    "example": "12 Alexander Avenue, Ikoyi"
                },
                "city": {
                    "type": "string",
                    "example": "Lagos"
        ...
        "models.UpdateListingRequest": {
            ...
            "properties": {
                ...
                "title": {
                    ...
                    "maxLength": 255,
                    "minLength": 3,
                    "example": "Updated Penthouse Title"
                },
                "type": {
                    "enum": [
                        "rent",
        ...
        "models.UpdateLocationRequest": {
            ...
            "properties": {
                "address": {
                    "type": "string",
                    "example": "14 Alexander Avenue, Ikoyi"
                },
                "city": {
                    "type": "string",
                    "example": "Lagos"
...
var SwaggerInfo = &swag.Spec{
	...
	Description:      "Production-ready Property Listings REST API with geospatial radius search, advanced filtering, and pagination.",
